<?php
class Wpdev_Megamenu_WalkerNav extends Walker_Nav_Menu {
    private $megaMenu = false;
    public function start_lvl(&$output, $depth = 0, $args = array()) {
        ...
        $classes = $depth > 0 ? array("dropdown-menu dropdown-menu-{$depth}") : array("dropdown-menu");
        if ($this->megaMenu) {
            $classes = array('dropdown-menu row megamenu');
        }
        /**
    ...
    public function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0) {
        ...
        $this->megaMenu = in_array('megamenu-li', $classes) ? true : false;
        ...
        if (in_array('image', $classes)) {
            $item_output = "<img src='{$atts['href']}' alt='{$title}' class='img-fluid' />";
        }
